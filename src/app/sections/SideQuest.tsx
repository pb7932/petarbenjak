    ...
    return (
      <div className='flex flex-col justify-center items-center max-container'>
          ...
          <div className='flex flex-col lg:flex-row justify-center items-stretch gap-12'>
              <SideQuestCard icon={dollar} alt={'Piggy bank icon'} title={t('h1')} text={t('p1')} link={'https://plkgalacticos.hr/'}></SideQuestCard>
              <SideQuestCard icon={gameControllerIcon} alt={'Game controller icon'} title={t('h2')} text={t('p2')}></SideQuestCard>
              <SideQuestCard icon={processIcon} alt={'Process icon'} title={t('h3')} text={t('p3')}></SideQuestCard>
          </div>
      </div>
    )
}
