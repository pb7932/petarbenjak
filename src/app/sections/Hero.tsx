  ...
  return (
    <div className='w-full flex flex-col justify-center items-center max-container xl:min-h-[90vh]'>
        <div className='flex-2 w-full py-0 md:py-24 flex flex-col  lg:flex-row justify-between items-center'>
            <div>
                <h1 ref={h1Ref} className={`slide-top-pre ${h2Animation} text-6xl font-inter lg:mt-24 leading-none ml-0 pl-0`}>Petar Benjak</h1>
            ...
            <div className='max-lg:scale-in-center-100-12 lg:scale-in-center-600 relative flex-1 flex flex-row justify-end items-center max-md:self-end'>
                <img className='z-10 max-h-[640px] object-fill md:ml-32 self-end xl:ml-0 mt-24 xl:mt-0' src={'Petar Benjak cropped2.png'} alt={"Petar Benjak"} width={200} height={400} ></img>
                <div className='w-96 h-96 rounded-md border-2 border-purple absolute bottom-0 lg:left-[50%] bg-purple-op'>
